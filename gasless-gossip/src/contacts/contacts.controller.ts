...
export class ContactsController {
  ...
  async getContact(@Request() req: any, @Param('id') id: string): Promise<ContactResponseDto> {
  ...
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Contact not found' })
  async deleteContact(@Request() req: any, @Param('id') id: string): Promise<void> {
  ...
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Contact not found' })
  async blockContact(@Request() req: any, @Param('id') id: string): Promise<ContactResponseDto> {
  ...
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Contact not found' })
  async unblockContact(@Request() req: any, @Param('id') id: string): Promise<ContactResponseDto> {
  ...
  async getContactGroups(@Request() req: any): Promise<ContactGroupResponseDto[]> {
  ...
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Group not found' })
  async deleteContactGroup(@Request() req: any, @Param('id') id: string): Promise<void> {
